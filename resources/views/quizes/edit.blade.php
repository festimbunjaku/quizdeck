<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @endif
                <form action="{{ route('quizes.update', ['quize' => $quiz->id])}}" method="POST" class="m-2">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input id="title" type="text" name="title" value="{{$quiz->title}}" class="block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-200 rounded-md focus:border-blue-400 focus:ring-blue-300 focus:ring-opacity-40 focus:outline-none focus:ring">
                </div>   
