...
<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
    ...
    <div>
        ...
        <p class="mt-4 text-gray-500 text-sm leading-relaxed">
            Organize and manage flashcards for efficient learning. Users can create, edit, or delete flashcards to ensure they align with quizzes and learning objectives.
        </p>
    </div>
    ...
    <div>
        ...
        <p class="mt-4 text-gray-500 text-sm leading-relaxed">
            Manage notes for your users. Add, edit, or delete notes, and ensure that they are organized in a way that benefits users during their learning process. These notes can be a valuable resource for users alongside quizzes and flashcards.
        </p>
    </div>
</div>
