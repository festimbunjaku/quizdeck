    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <form method="GET" action="{{ route('questions.index') }}" class="mt-2 ml-[88px]">
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-4 py-4 text-sm text-right whitespace-nowrap">
                                                    <div class="inline-flex items-center gap-x-4">
                                                        <a href="{{route('questions.show', ['question' => $question->id]) }}" class="text-gray-500 hover:text-blue-500">
                                                        ...
                                                        <a href="{{ route('questions.edit', ['question' => $question->id]) }}" class="text-gray-500 hover:text-green-500">
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
