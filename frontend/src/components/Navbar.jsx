    ...
    <nav className="bg-white fixed w-full z-20 top-0 left-0 border-b border-gray-200">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex md:order-2 space-x-3">
          ...
          >
            <NavLink to="/homePage" activeClassName="text-orange-500">
              Login
            </NavLink>
          </button>
          <button
            ...
            className="text-white bg-orange-500 hover:bg-orange-600 focus:ring-4 focus:outline-none focus:ring-orange-300 font-medium rounded-lg text-sm px-4 py-2"
          >
            <NavLink to="/" activeClassName="text-orange-500">
              Sign Up
            </NavLink>
          </button>
          <button
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `block py-2 px-3 rounded md:p-0 ${
                    isActive ? 'text-orange-500' : 'text-gray-900 hover:bg-gray-100 md:hover:bg-transparent md:hover:text-orange-500'
                  }`
                }
              >
                Home
